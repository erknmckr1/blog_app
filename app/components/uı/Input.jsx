...
function Input(props) {
  const { type, prop, errorMessage, touched, placeholder, ...inputProps } =
    props;
  return (
    <div className="w-full">
      <label className="relative block cursor-text w-[400px]">
        <input
          type={type}
          className={`h-14 ${prop}  border outline-none px-4 peer 
